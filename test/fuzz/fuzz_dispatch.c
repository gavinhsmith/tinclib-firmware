...
static const uint8_t types[] = {
    TINC_T_HELLO, TINC_T_STATUS, TINC_T_INFO, TINC_T_REQ_BEGIN, TINC_T_REQ_STATUS,
    TINC_T_HDR_GET, TINC_T_REQ_ABORT, TINC_T_BODY_WRITE, TINC_T_BODY_READ,
    TINC_T_WIFI_GET, TINC_T_WIFI_SET, TINC_T_WIFI_FORGET
};
